...
proc create_root_design { parentCell } {
  ...
  # Create instance: my_axis_float_matp_0, and set properties
  set my_axis_float_matp_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:my_axis_float_matp:1.0 my_axis_float_matp_0 ]

  set_property -dict [ list \
   CONFIG.TDATA_NUM_BYTES {4} \
 ] [get_bd_intf_pins /my_axis_float_matp_0/m_axis]

  set_property -dict [ list \
   CONFIG.TDATA_NUM_BYTES {4} \
 ] [get_bd_intf_pins /my_axis_float_matp_0/s_axis]

  # Create instance: my_axis_float_matp_1, and set properties
  set my_axis_float_matp_1 [ create_bd_cell -type ip -vlnv xilinx.com:user:my_axis_float_matp:1.0 my_axis_float_matp_1 ]

  set_property -dict [ list \
   CONFIG.TDATA_NUM_BYTES {4} \
 ] [get_bd_intf_pins /my_axis_float_matp_1/m_axis]
  ...
  connect_bd_intf_net -intf_net axi_dma_0_M_AXIS_MM2S [get_bd_intf_pins axi_dma_0/M_AXIS_MM2S] [get_bd_intf_pins my_axis_float_matp_0/s_axis]
  ...
  connect_bd_intf_net -intf_net axi_dma_1_M_AXIS_MM2S [get_bd_intf_pins axi_dma_1/M_AXIS_MM2S] [get_bd_intf_pins my_axis_float_matp_1/s_axis]
  ...
  connect_bd_intf_net -intf_net my_axis_float_matp_0_m_axis [get_bd_intf_pins axi_dma_0/S_AXIS_S2MM] [get_bd_intf_pins my_axis_float_matp_0/m_axis]
  connect_bd_intf_net -intf_net my_axis_float_matp_1_m_axis [get_bd_intf_pins axi_dma_1/S_AXIS_S2MM] [get_bd_intf_pins my_axis_float_matp_1/m_axis]
