...
#
# Generated by export_simulation on Fri May 04 15:47:09 +0100 2018
#
################################################################################
...
'-reset_run' switch to the './floating_point_mult_0.sh' script.

./floating_point_mult_0.sh -reset_run
...
./floating_point_mult_0.sh -noclean_files

For more information on the script, please type './floating_point_mult_0.sh -help'.
