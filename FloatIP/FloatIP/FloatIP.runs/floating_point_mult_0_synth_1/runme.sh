...
HD_PWD='D:/User/Desktop/COProj/FloatIP/FloatIP/FloatIP.runs/floating_point_mult_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log floating_point_mult_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source floating_point_mult_0.tcl
